      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="rounded-xl border border-slate-800 p-4">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Full Insights (reach, engagement, follower growth) live in the Instagram app itself —
            embedding them here would need Meta&apos;s Business API and app review. For now, quick link:
          </p>
          <a
            href="https://www.instagram.com/sochillbathclub/"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-3 inline-block rounded-lg bg-cyan-500 px-4 py-2 text-sm font-medium text-slate-950 hover:bg-cyan-400"
          >
